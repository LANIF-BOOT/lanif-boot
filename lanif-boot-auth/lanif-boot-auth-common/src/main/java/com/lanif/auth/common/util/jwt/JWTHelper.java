...
import com.lanif.auth.common.constants.CommonConstants;
...
public class JWTHelper {
	...
	public static IJWTInfo getInfoFromToken(String token, String pubKeyPath) throws Exception {
		...
		return new JWTInfo(body.getSubject(), obj2str(body.get(CommonConstants.JWT_KEY_USER_ID)),
				obj2str(body.get(CommonConstants.JWT_KEY_NAME)));
	}
